...
const mapDispatchToProps = (dispatch) => {
  return {
    itemChange: (item, i = "add") => {
      dispatch({
        type: "QUALITY_PHONE_ITEM",
        item,
      });
    },
  };
                        ...
                        <tr key={item.maSP}>
                          ...
                          <td>
                            <div className="flex items-center justify-between">
                              <button
                                onClick={() => this.props.itemChange(item)}
                              ...
                              <span>{item.qty}</span>
                              <button className="p-2 bg-red-500 rounded outline-none text-white leading-none border-none focus:outline-none hover:scale-95 transition-all">
                                -
                              </button>
                            </div>
                          </td>
