    ...
    return (
      <Fragment>
        <div className="container mt-4">
          <div className="relative w-10 max-w-[40px] ml-auto">
            <svg
            ...
            <span className="absolute inline-block top-0 right-0 translate-x-8 -translate-y-3 text-sm border-2 p-[5px] rounded-full leading-none text-red-600">
              3
            </span>
          </div>
