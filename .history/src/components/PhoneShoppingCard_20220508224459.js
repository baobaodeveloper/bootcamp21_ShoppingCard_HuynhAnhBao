                          ...
                          <td>
                            <div className="flex items-center justify-between">
                              <button
                                ...
                                className="p-2 bg-blue-500 rounded outline-none text-white leading-none border-none focus:outline-none hover:scale-95 transition-all"
                              >
                                +
                              </button>
                              <span>{item.qty}</span>
                              <button
                                ...
                                className="p-2 bg-red-500 rounded outline-none text-white leading-none border-none focus:outline-none hover:scale-95 transition-all"
                              >
                                -
                              </button>
                            </div>
