...
class PhoneShoppingCard extends Component {
  render() {
          ...
          >
            <div className="modal-content">
                        ...
                        <tr key={item.maSP}>
                          ...
                          <td>
                            <div className="flex items-center justify-between">
                              <button
                                onClick={() =>
                                  this.props.itemChangeIncrea(item)
                                }
                                className="p-2 leading-none text-white transition-all bg-blue-500 border-none rounded outline-none focus:outline-none hover:scale-95"
                              >
                                +
                              </button>
                              <span>{item.qty}</span>
                              <button
                                onClick={() =>
                                  this.props.itemChangeDecrea(item)
                                }
                                className="p-2 leading-none text-white transition-all bg-red-500 border-none rounded outline-none focus:outline-none hover:scale-95"
                              >
                                -
                              </button>
                            </div>
              ...
              <div className="modal-footer">
                <button
                  type="button"
                  className="bg-red-500 btn btn-secondary"
                  data-dismiss="modal"
                >
                  Close
                </button>
...
export default connect(mapStateToProps, mapDispatchToProps)(PhoneShoppingCard);
